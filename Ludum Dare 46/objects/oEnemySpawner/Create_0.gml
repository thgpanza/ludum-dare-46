...
smallEnemiesSpawnTimer     = room_speed;     // The cooldown (1 second) between spawns for the small enemies.
...
bigEnemiesSpawnTimer       = room_speed * 2; // The cooldown (2 seconds) between spawns for the big enemies.
