...
if (enemiesToSpawn == 0 && instance_number(oEnemy) == 0 && global.canStartNextTurn) {
	...
	var smallEnemyMap = oGameController.enemies[oGameController.smallEnemyMapIndex];
	...
	UpdateEnemy(oGameController.smallEnemyMapIndex);
	
	var bigEnemyMap = oGameController.enemies[oGameController.bigEnemyMapIndex];
